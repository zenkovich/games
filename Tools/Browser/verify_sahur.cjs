...
(async()=>{
 ...
 const result={passed:true,realInput:true,noEconomyCheats:true,duration,progressionSeconds:milestones.at(-1).seconds,trips,final,referenceField:{widthMeters:22,lengthMeters:26,beds:3,brains:240,cameraYaw:35},milestones,touch,fixedJoystick,desktop:bounds,files,errors,perf};
